...
## Documentation
* [User Guide](http://mrgsolve.org/user-guide): In-depth description and 
  discussion about how mrgsolve works, including code block reference. The 
  user guide is available in [html](http://mrgsolve.org/user-guide) and 
  [pdf](https://mrgsolve.org/user-guide/mrgsolve-user-guide.pdf) versions.
