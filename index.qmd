...
* [Vignette](http://mrgsolve.org/package-vignette): A vignette to help you get
  started with mrgsolve, available in [html](http://mrgsolve.org/package-vignette) 
  or [pdf](http://mrgsolve.org/package-vignette/mrgsolve-vignette.pdf) format.
