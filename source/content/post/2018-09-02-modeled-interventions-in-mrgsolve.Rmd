...
In this example, we want `KA` to start at the time of the oral
...
two hours later.  We use `EVID=33` for that event.  This is a arbitrary choice
(it could be [almost] anything).  The idea here is that, when
