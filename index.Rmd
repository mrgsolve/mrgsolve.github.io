---
pagetitle: "Simulate from PKPD & QSP models in R"
output: 
  html_document:
    toc: FALSE
...
# <font class=mrgg>Simulate from PKPD & QSP models in R</font> <img src="images/mrgsolve_hex.png" align="right"></img>
...
* [R documentation](http://mrgsolve.github.io/docs): All `mrgsolve` documentation 
  that you would find in the `R` help system
* [Vignettes](http://mrgsolve.github.io/vignettes): Package vignettes
* [Quick hit demos](`r .ref$quick`): Features that you might have a hard time 
  finding in other documentation
...
the "Help Topics" menu in the nav bar at the top of the [mrgsolve.github.io](https://mrgsolve.github.io) main page.
